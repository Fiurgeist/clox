...
static void patchJump(int offset) {
  // -2 for the 2 byte jump offset itself
...
static void initCompiler(Compiler *compiler, FunctionType type) {
  ...
  compiler->function = NULL; // nulling before setting -> garbage collection-related paranoia
  compiler->type = type;
...
static void binary(bool canAssign) {
  ...
  default: errorAtCurrent("Invalid binary operator");
  }
}
...
static void literal(bool canAssign) {
  ...
  default: errorAtCurrent("Invalid literal");
  }
}
...
static void unary(bool canAssign) {
  ...
  default: errorAtCurrent("Invalid unary operator");
  }
}
